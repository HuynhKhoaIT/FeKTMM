      ...
      {/* <Row className={cx('sliderHome')}>
                <Col span={24}>
                    <Slider dots={true} infinite={true} speed={500} slidesToShow={1} slidesToScroll={1} autoplay={true}>
                        ...
                        <div>
                            <img style={{ width: '100%', height: '566px' }} src={'https://lh3.googleusercontent.com/7u6ZwGXulC8OhyC6LIb6REDtUGTJhLSnINRxt9JVpfbgdZqrY4SwufxLt11Eg-vjNe3vwiNg8R5iRiFA7MD5P2Rn1RENYqqG=w1920-rw'} />
                        </div>
                        <div>
