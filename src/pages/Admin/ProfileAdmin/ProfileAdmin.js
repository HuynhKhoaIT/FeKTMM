...
function ProfileAdmin() {
  ...
  const handleSaveChangeProfile = async () => {
    ...
    const result = await profileAdminService.updateProfile(
      user?._id,
      updateProfileData
    );
    if (result === 1) {
  ...
  const handleSaveChangePassword = async () => {
    if (newPassword === confirmNewPassword) {
      if (oldPassword === user._pw) {
        const saveChangePassword = await profileAdminService.changePassword(
          user?._id,
          { _pw: newPassword }
        );
  ...
  return (
    <div className={cx("container-fluid")}>
      <div className={cx("row")}>
        ...
        <div
          className={cx(
            "col-12 col-lg-12 col-xl-10 container-fluid",
            "content-section"
          )}
        >
            ...
            <div className={cx("content")}>
              <div className={cx("container-fluid")}>
                <div className={cx("row align-items-center", "profile")}>
                  <div
                    className={cx(
                      "col-lg-7 col-md-7 d-none d-lg-block",
                      "profile-info"
                    )}
                  >
                    <div className={cx("row")}>
                      ...
                      <div
                        className={cx(
                          "col-lg-9 col-md-9 d-flex justify-content-end",
                          "info"
                        )}
                      >
                        <div>
                    ...
                    <div className={cx("row")}>
                      ...
                      >
                        <div>
                          {user._gender === "female" ? <p>Nữ</p> : <p>Nam</p>}
                        </div>
                      </div>
                    </div>
                  </div>
                  <div
                    className={cx(
                      "col-lg-5 col-md-5 d-none d-lg-block",
                      "profile-avatar"
                    )}
                  >
                  ...
                  <div
                    className={cx(
                      "col-12 col-md-12 d-block d-lg-none",
                      "profile-avatar"
                    )}
                  >
                    <div className={cx("d-flex justify-content-center")}>
                  ...
                  >
                    <div className={cx("row")}>
                      ...
                      <div
                        className={cx(
                          "col-8 col-md-9 d-flex justify-content-end",
                          "info"
                        )}
                      >
                        <div>
          ...
          <Modal
            ...
            className={cx("update-profile-modal")}
          >
